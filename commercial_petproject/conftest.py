...
from commercial_petproject.db.dependencies import get_db_session
from commercial_petproject.db.utils import create_database, drop_database
from commercial_petproject.settings import settings
from commercial_petproject.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from commercial_petproject.db.meta import meta  # noqa: WPS433
    from commercial_petproject.db.models import load_all_models  # noqa: WPS433
